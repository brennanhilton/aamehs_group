...
#adds building codes to math and ela datasets
```{r}
...
codes_ela_scores <- left_join(ela_scores, building_codes, by = "school_name")
view(codes_ela_scores)

codes_math_scores <- left_join(math_scores, building_codes, by = "school_name")
view(codes_math_scores)
```

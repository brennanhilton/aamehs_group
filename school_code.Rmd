...
plot_1 = ggplot(data, aes(fill=demographics, y=average_percentage, x=elevated_result)) + 
    geom_bar(position="dodge", stat="identity") + 
    labs(x = "Elevated Lead Result", y = "Demographics (%)")

plot_1

#plot_2 = ggplot(data, aes(fill=elevated_result, y=average_percentage, #x=demographics)) + 
    #geom_bar(position="dodge", stat="identity") + 
